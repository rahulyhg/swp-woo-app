...
if( !class_exists( 'SWPappspecificusersorder' ) ){
    class SWPappspecificusersorder{
        ...
        function swp_app_enpoints_users_order(){
            ...
            register_rest_route( $this->rest_url, '/getusersorder', array(
                'methods' => 'GET',
                'callback' => array( $this, 'swp_get_users_order' ),
               // 'permission_callback' => array( $this, 'get_items_permissions_check' ),
                'args' => array(
                    'post_per_page' => array(
                        'default' => 10,
        ...
        */
        public function swp_get_users_order($request){
            ...
            if( $currentuser == true ){
                ...
                return new WP_Error( 'rest_order_error', __( 'Sorry, User not logged in.','swp' ), array( 'status' => 400 ) );
            }
        }
