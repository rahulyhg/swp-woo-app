...
/**********************************************
* this funciton is use for hide category on mobile and add category image
* @product category texonomy 
**********************************************/
if( !class_exists( 'swp_product_cat_on_mobile' ) ){
    class swp_product_cat_on_mobile{
        
        /***** create construct for texonomy *****/
