...
if( !class_exists( 'SWPsettingform' ) ){
    ...
    {   
        ...
        function swp_product_title_for_buyer_callback($args){
            ...
            echo '<input type="text" class="tab-content" id="swp_product_title_for_buyers" name="swp_app_general_options[swp_product_title_for_buyers]" value="' . $options['swp_product_title_for_buyers'] . '"></input>';
        ...
        public function swp_buyer_product_description_callback()
        {
            ...
            echo '<input type="text" class="tab-content" id="swp_buyer_product_descriptions" name="swp_app_general_options[swp_buyer_product_descriptions]" value="' . $options['swp_buyer_product_descriptions'] . '"></input>';
...
-->
                    ...
                    <a href="?page=swp-app-general-setting-options&tab=swp_app_test_settings" class="nav-tab <?php echo $active_tab == 'swp_app_test_settings' ? 'nav-tab-active' : ''; ?>">Test</a>
