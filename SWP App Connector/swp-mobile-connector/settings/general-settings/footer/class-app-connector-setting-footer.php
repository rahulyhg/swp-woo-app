...
{   
    ...
    public function swp_app_footer_title_callback($args) { 
        ...
        echo '<input type="text" id="'  . $args[0] . '" name="swp_app_footer_option[' . $args[0] . ']" value="' . $options[''  . $args[0] . ''] . '"></input>';
    ...
    public function swp_app_footer_social_facebook_callback($args) { 
        ...
        echo '<input type="text" id="' . $args[0] . '" name="swp_app_footer_social_link[' . $args[0] . ']" value="' . $options[''  . $args[0] . ''] . '"></input>';
