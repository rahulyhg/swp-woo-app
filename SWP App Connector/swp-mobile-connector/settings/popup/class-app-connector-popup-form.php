...
*****************************************************/
    ...
    $link = get_option('swp-popup-homepage-link');
    ...
    //		bamobile_mobiconnector_print_notices();
        ...
        <form accept-charset="UTF-8" action="<?php echo admin_url().'/admin-post.php?action=app_update_popup'; ?>" class="form-horizontal" method="post" id="settings_popup">

            <input type="hidden" name="action" value="app_update_popup">

            <?php wp_nonce_field( 'app_update_popup' ); ?>
                    ...
                    <div class="connector-popup_configuration">
                        ...
                        <div class="connector-popup_settings_field">
                            ...
                            <div class="connector-form-control">
                                ...
                                <input type="text" name="swp_popup_link" id="connector_check_popup_link" value="<?php echo $link; ?>"/>
