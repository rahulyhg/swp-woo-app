<?php
	...
	if (isset($_REQUEST['swpvalue']) && isset($_REQUEST['swpselected']) && isset($_REQUEST['baseurl'])) {
			
		$value = $_REQUEST['swpvalue'];
		$selected = $_REQUEST['swpselected'];
		...
		<div id="comtent-list-url-notification">		
			<div id="content-url-notification">
				<span><?php echo __('Sorry' . $value.' not exist, Please try again...','swp'); ?></span>
			</div>
		</div>
<?php
			}
