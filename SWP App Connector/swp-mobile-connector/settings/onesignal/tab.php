...
<h2 class="nav-tab-wrapper" <?php if($wp_version < '4.8'){echo 'style="border-bottom: 1px solid #ccc"';}  ?>>
	<a id="swp-general-settings" href="?page=app-connector&amp;wootab=settings" class="nav-tab nav-tab-general<?php echo (($active_tab == 'settings') ? ' nav-tab-active' : ''); ?>"><?php echo __('Settings','swp');?></a>
	<?php
	...
	?>
		<a id="swp-settings-currency" href="?page=swp-one-signal&amp;wootab=currency" class="nav-tab nav-tab-template<?php echo (($active_tab == 'currency') ? ' nav-tab-active' : ''); ?>"><?php echo __('Currency','swp');?></a>	
	<?php
		}
	?>	
</h2>